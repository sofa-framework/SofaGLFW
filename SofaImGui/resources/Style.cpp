...
void setDeepDarkStyle()
{
    ...
    colors[ImGuiCol_FrameBg]                = ImVec4(0.85f, 0.85f, 0.85f, 0.55f);
    ...
    colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.65f, 0.65f, 0.65f, 0.55f);
    ...
    colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.00f, 0.00f, 0.00f, 0.55f);
...
void setYetAnotherDarkThemStyle()
{
...
/// from https://github.com/ocornut/imgui/issues/707#issuecomment-430613104
void setCherryStyle()
{
...
void setStyle(const std::string& style)
{
    ...
    else if (style == "light_green")
    {
        setLightGreenStyle();
    }
    else if (style == "yet_another_dark")
    {
        setYetAnotherDarkThemStyle();
    }
